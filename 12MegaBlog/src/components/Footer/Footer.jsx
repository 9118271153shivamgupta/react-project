            ...
            <div className="flex h-full flex-col justify-between">
              ...
              {/* <div className="mb-4">
                <p className="text-sm text-gray-600">
                  &copy; This website was made by Shivam Kumar Gupta
                </p>
              </div> */}
              {/* Social Media Icons */}
              <div className="flex space-x-4">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
                  <FaFacebookF className="text-gray-900 hover:text-gray-700" size={24} />
                </a>
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer">
                  <FaLinkedinIn className="text-gray-900 hover:text-gray-700" size={24} />
                </a>
              </div>
              <div className="mb-4">
